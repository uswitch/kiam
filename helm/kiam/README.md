...
`agent.seLinuxEnabled` | Enables templating of the agent container's SELinux labels | `false`
...
`server.seLinuxEnabled` | Enables templating of the server container's SELinux labels | `false`
